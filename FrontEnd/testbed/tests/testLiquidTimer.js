...
//Sets the box as the center of the simulation
  ...
  shape.SetAsBoxXYCenterAngle(0.9, 0.4, new b2Vec2(2, 2.5), 0);
  ...
  var pd2 = new b2ParticleGroupDef;
  pd2.flags = b2_tensileParticle | b2_viscousParticle;
  pd2.shape = shape;
  particleSystem.CreateParticleGroup(pd2);
